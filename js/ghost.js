...
function getGhostHTML(ghost) {
    const color = (gGame.isPowerOn)? "DarkBlue" : ghost.color
    return `<span data-id="${ghost.id}" style="color:transparent; text-shadow: 0 0 0 ${color};">${GHOST}</span>`
}